...
# The default below is only for local/dev use - always set a real SECRET_KEY in production.
SECRET_KEY = config(
    'SECRET_KEY',
    default='django-insecure-5y2(7eusc_alk=lzs2(9*!p3&w!&is7wdydaqeb(ge$(29d#2+'
)
