        ...
        <ul>
          ...
          <li>
            ...
            <ul className="submenu">
              ...
              <li>
            <Link to={process.env.PUBLIC_URL + "/Be-a-Premium-Member"}>
              {t("Premium Member")}
            </Link>
          </li>
            </ul>
          ...
          <li>
            <Link to={process.env.PUBLIC_URL + "/blog-standard-overall"}>
              {t("blog")}
              {sidebarMenu ? (
                <span>
                  <i className="fa fa-angle-right"></i>
            ...
            <ul className="submenu">
              ...
              <li>
                ...
                to={{
                  ...
                  search: "?link=get_all_post/",
                }}
                >
                  {t("Blogs Feed with Filter")}
                </Link>
              </li>
